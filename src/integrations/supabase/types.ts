...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      log_event: {
        Args: { _event: string; _level: string; _meta: Json; _route: string };
        Returns: undefined;
      };
      ride_accept: {
        Args: { _ride_id: string };
      ...
      ride_set_payment_method: {
        Args: { _method: string; _ride_id: string };
        Returns: {
          created_at: string;
          distance_km: number;
          driver_id: string | null;
      ...
      wallet_transfer: {
        Args: { _amount: number; _note: string; _to_phone: string };
        Returns: Json;
      };
      wallet_withdraw: {
        Args: { _amount: number };
    ...
    Enums: {
      app_role: "passenger" | "driver" | "admin" | "support" | "sales" | "super_admin";
      ride_payment_method: "wallet" | "cash" | "card_demo";
      ride_status:
        | "requested"
        | "matched"
        | "arriving"
